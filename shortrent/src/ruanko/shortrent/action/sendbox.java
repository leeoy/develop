...
public class sendbox extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7935972239641547080L;
...
List<mail> users = userBiz.getAllsend(id);


request.setAttribute("users", users);


request.getRequestDispatcher("sendbox.jsp").forward(request, response);
}
