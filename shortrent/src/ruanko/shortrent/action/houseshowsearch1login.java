...
public class houseshowsearch1login extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3948043640916463042L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("houseshowsearch1login.jsp").forward(request, response);
	}
