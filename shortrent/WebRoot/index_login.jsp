...
<div style="font-size:18px;text-align:right;background:#ffffdd">
	<a href="center.html">
		 <% 
  		User user = (User)session.getAttribute("userinfo");
  	%>
	<% 
  	if(user!=null) out.println(user.getUser_account());
  	%>
  	</a>	
		&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="background:url(image/yyyyy.gif);width:1000px;height:200px">
</div>

<div style="width:100%">
<div id="headerMenu" style="">
<ul class="menu">
<li><a href="UserLogin?user_account=<%=user.getUser_account() %>&user_password=<%=user.getUser_password() %>" name="t1" class="">首  页|</a></li>
<li><a href="UserLogin?user_account=<%=user.getUser_account() %>&user_password=<%=user.getUser_password() %>">月租短租|</a></li>
<li><a href="UserLogin?user_account=<%=user.getUser_account() %>&user_password=<%=user.getUser_password() %>">房屋搜索|</a></li>
<li><a href="UserLogin?user_account=<%=user.getUser_account() %>&user_password=<%=user.getUser_password() %>">精品推荐|</a></li>
<li><a href="MAILTO:wt52571314@126.com">联系我们|</a></li>
<li><a href="UserLogin?user_account=<%=user.getUser_account() %>&user_password=<%=user.getUser_password() %>">关于我们</a></li>
</ul>
</div>
</div>   
 ...
 <a name="t2"></a>
 		<form name="form1" action="houseshowsearchlogin" method="post" target="view">
  			...
  			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Houseshow?state=yes&&i=0">查看更多...</a> 		
  			</form>
        <iframe width="100%" height="100%" scrolling="auto" name="view" style="border: 0px;" src="houseshowlogin?state=yes" frameBorder="0"></iframe>
	</div>
 </div>
...
<div style="width:1000px;height:600px;border:1px solid #e3e197;background:url(image/t1.jpg);margin:20 0;padding:55 0 0 0;">
	...
	<a name="t3"></a>
 		...
 		<form name="form1" action="houseshowsearch1login" method="post" target="view1">
	...
	<iframe width="100%" height="100%" scrolling="auto" name="view1" style="border: 0px;" src="houseshowlogin?state=yes" frameBorder="0"></iframe>
	</div>
</div>
