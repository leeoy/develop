...
<%
	//从request里获取新闻列表
	List<House> list = (List<House>)request.getAttribute("house");
...
<html>
  ...
  <body style="background:url(image/333.bmp)">
	...
	<table width="209" border="0">
      ...
      <tr>
        <td><a href="mail_add?houseid=<%=house.getHouse_id() %>" target="_blank">给房主发信</a></td>
      </tr>
      <tr>
        <td><a href="days?id=<%=house.getHouse_id()%>" target="_blank">下订单</a></td>
      </tr>
    </table>
 </td>
