...
<a href="mailShowList?userinfo=<%=user.getUser_id()%>"
	class="button white">显示所有邮件</a>
&nbsp;
<a href="mailShowListread?userinfo=<%=user.getUser_id()%>"
	class="button white">显示已读邮件</a>
&nbsp;
<a href="mailShowListnoread?userinfo=<%=user.getUser_id()%>"
	class="button white">显示未读邮件</a>
								...
								<TABLE id=grid
									...
									<TBODY>
										...
										<TR
											...
											<TD>
												<form action="mailUpdate?mail_id=<%=mail.getMail_id()%>"
													method="post">
													<input type="radio" name="mail_state" value="n"
														<%=mail.getMail_statecheckn()%>>
													未读
													<input type="radio" name="mail_state" value="y"
														<%=mail.getMail_statechecky()%>>
													已读
													<br />
													<center>
											...
											<TD>
												<a href="deletemail.jsp?mail_id=<%=mail.getMail_id()%>"
													class="button white">删除</a>
											</TD>
										</TR>
										<%
											}
