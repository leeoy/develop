...
<html>
	<head>
		...
		<title>My JSP 'add_room.jsp' starting page</title>
	...
	china['河北省'] = new Array('石家庄', '唐山市', '邯郸市', '秦皇岛', '保市定', '张家口', '承德市',
			'廊坊市', '沧州市', '衡水市', '邢台市');
	...
	<body>
		...
		%>
		<form  method="post" action="addhouse?owner_id=<%=user.getUser_id()%>" target="_blank">
			<table align="center">
				<caption>
					<h4>
						添加新房屋
				...
				<tr>
					...
					<td>
						房屋地址:
						<select name="house_address1"
							onchange="chinaChange(this,document.getElementById('house_address2'));">
							<option value="">
								请选择省份
							</option>
							<option value="北京市">
						...
						<select name="house_address2" id="house_address2">
							<option value="">
								请选择市区
							</option>
						</select>
				...
				<tr>
					...
					<td>
						适合人数：
						<input type="text" name="house_suithuman" id="house_suithuman">
					</td>
				</tr>
				<tr>
					<td>
						房屋租金：
						<input type="text" name="house_price" id="house_price">
					</td>
					<td>
						房屋配套：
