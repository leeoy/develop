...
import com.zhn.bluetoothUtil.BluetoothCommunSocket;
import com.zhn.bluetoothUtil.BluetoothServerConnThread;
	...
	public void addBondDevicesToListView() {  
	       ...
	       this.bondDevicesListView.setOnItemClickListener(new OnItemClickListener() { 
	           ...
	           public void onItemClick(AdapterView<?> arg0, View arg1,    
	               ...
	               intent.setClassName(ServerActivity.this,"com.zhn.bluetooth.ServerActivity1");    
...
//					sendBroadcast(connSuccIntent);
				...
				case BluetoothTools.MESSAGE_READ_OBJECT:
					...
					if(transmit.getFilename()!=null&&!"".equals(transmit.getFilename())){
						text = "receive file from remote " + new Date() + " :\r\n" + transmit.getFilename() + "\r\n";
					}else{
						text = "receive message from remote " + new Date() + " :\r\n" + transmit.getMsg() + "\r\n";
					}
		...
		// 这里处理逻辑代码，注意：该方法仅适用于2.0或更新版的sdk
			...
			mpDialog.setProgress(0);
			Intent intent = new Intent();
			intent.setClassName(ServerActivity.this,"com.zhn.bluetooth.MainActivity");    	
            ServerActivity.this.startActivity(intent);   		
			super.onBackPressed();
		}
