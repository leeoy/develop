...
import com.zhn.bluetoothUtil.BluetoothClientService;
import com.zhn.bluetoothUtil.BluetoothTools;
import com.zhn.bluetoothUtil.TransmitBean;
import com.zhn.file.SelectFileActivity;
import com.zhn.mybluetooth.R;


public class ServerActivity1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spDialog=new ProgressDialog(ServerActivity1.this);
		rpDialog=new ProgressDialog(ServerActivity1.this);
	//	serversText = (TextView)findViewById(R.id.clientServersText);
		...
		mSelectFileBtn.setOnClickListener(new OnClickListener() {			
			...
			public void onClick(View v) {				
				Intent intent = new Intent(ServerActivity1.this, SelectFileActivity.class);
				startActivityForResult(intent, ServerActivity1.RESULT_CODE);				
			}
		});
		...
		sendBtn.setOnClickListener(new OnClickListener() {		
			...
			public void onClick(View v) {
				...
				if ("".equals(sendEditText.getText().toString().trim())) {
					Toast.makeText(ServerActivity1.this, "输入不能为空", Toast.LENGTH_SHORT).show();
				} else {
					//发送消息
		...
		filesendBtn.setOnClickListener(new OnClickListener() {		
			...
			public void onClick(View v) {
				...
				if ("".equals(mSendFileNameTV.getText().toString().trim())) {
					Toast.makeText(ServerActivity1.this, "未选择文件", Toast.LENGTH_SHORT).show();
				} else {
	...
	public  BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {	
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothTools.ACTION_CONNECT_ERROR.equals(action)) {//连接失败
				spDialog.dismiss();
				rpDialog.dismiss();
				Toast.makeText(ServerActivity1.this, "通讯失败", 2000).show(); 
